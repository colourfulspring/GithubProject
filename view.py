...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(150, 670, 521, 81))
        ...
        sizePolicy.setHeightForWidth(self.wordNumberLabel.sizePolicy().hasHeightForWidth())
        self.wordNumberLabel.setSizePolicy(sizePolicy)
        ...
        self.engNumberLabel = QtWidgets.QLabel(self.gridLayoutWidget)
        self.engNumberLabel.setText("")
        self.engNumberLabel.setObjectName("engNumberLabel")
        self.gridLayout.addWidget(self.engNumberLabel, 0, 3, 1, 1)
...
"你也可以在文本框中添加，删除或编辑文本，提示栏会随着你的操作实时更新这些数据。"))
        ...
        self.label_3.setText(_translate("MainWindow", "字母总数："))
